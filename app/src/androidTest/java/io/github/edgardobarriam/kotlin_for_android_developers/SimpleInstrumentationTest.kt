...
import io.github.edgardobarriam.kotlin_for_android_developers.ui.activities.MainActivity
...
class SimpleInstrumentationTest {
    ...
    @Test fun itemClick_navigatesToDetail() {
        onView(withId(R.id.recyclerViewForecastList)).perform(
                RecyclerViewActions
    ...
    @Test fun modifyZipCode_changesToolbarTitle() {
        ...
        onView(withText(R.string.settings)).perform(replaceText("28830"))
        pressBack()
